...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/07/24 17:53:02 by mailinci          #+#    #+#             */
/*   Updated: 2025/07/24 17:53:05 by mailinci         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "minishell.h"

static void	ft_concatenate_tokens(t_token *start, t_token *end, \
										char *buffer, int first_arg)
{
	t_token	*current;
	char	*ptr;
...
static t_token	*process_token_group(t_token *cur, t_token *end, \
										char **result_str, int first_arg)
{
	t_token	*group_start;
	t_token	*group_end;
