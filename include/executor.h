...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/07/24 15:52:05 by mailinci          #+#    #+#             */
/*   Updated: 2025/07/24 15:52:12 by mailinci         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		execute_in_parent_and_close( \
		t_node *node, t_shell_state *state, int pipe_fd[2], int prev_fd);
...
void	exec_child( \
		t_node *node, int pipe_out[2], int pipe_in, t_child_context *ctx);
